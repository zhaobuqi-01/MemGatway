...
func (s *serviceInfoLogic) getServiceAddress(serviceDetail *dao.ServiceDetail) (string, error) {
	...
	case utils.LoadTypeHTTP:
		if serviceDetail.HTTPRule.RuleType == utils.HTTPRuleTypePrefixURL {
